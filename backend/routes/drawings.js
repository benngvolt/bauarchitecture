...
const drawingsCtrl = require('../controllers/drawings');
...
router.post('/',
            ...
            uploadImages,
            drawingsCtrl.createDrawing);

router.get('/',
    drawingsCtrl.getAllDrawings);

router.get('/:id',
    drawingsCtrl.getOneDrawing);

router.delete('/:id',
            // auth,
            drawingsCtrl.deleteOneDrawing,
            deleteImages);
